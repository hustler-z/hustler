 ...
 *
 *
 * FilePath: spiffs_spi_basic_example.c
...
int FSpiffsSpiBasicExample(void)
{
    ...
    if (ret == 0)
    {
        printf("%s@%d: Sfud spi spiffs basic example [success].\r\n", __func__, __LINE__);
        printf("[system_example_pass]\r\n");
    }
    else
    {
        printf("%s@%d: Sfud spi spiffs basic example [failure].\r\n", __func__, __LINE__);
    }
