 ...
 *
 *
 * FilePath: sata_pcie_pio_example.c
 * Date: 2022-02-10 14:53:42
 * LastEditTime: 2022-02-17 17:46:03
 * Description:  This file is for sata pcie pio example function implmentation
 *
 * Modify History:
...
int FSataPciePioExample()
{
    ...
    /*write data*/
    u8 write_buf[FSATA_BLOCK_SIZE] = "Sata Pcie Pio Write Successfully!!!";
    ...
    if (ret == FT_SUCCESS)
    {
        printf("%s@%d: Sata pcie pio example success !!! \r\n", __func__, __LINE__);
    }
    else
    {
        printf("%s@%d: Sata pcie pio example failed !!!, ret = %d \r\n", __func__, __LINE__, ret);
        return FSATA_ERR_OPERATION;
    }
