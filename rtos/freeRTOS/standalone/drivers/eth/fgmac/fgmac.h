...
#define FGMAC_DMA_RDES0_LAST_OR_FIRST_FLAG        (FGMAC_DMA_RDES0_FIRST_DESCRIPTOR | FGMAC_DMA_RDES0_LAST_DESCRIPTOR)
...
/* 完成FGMAC驱动实例JUMBO帧接收使能*/
FError FGmacJumboEnable(FGmac *instance_p);
