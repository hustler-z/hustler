...
#define CONFIG_BOARD_NAME "E2000D_demo"
#define CONFIG_E2000D_DEMO
/* CONFIG_OTHER_BOARD_NAME is not set */
/* end of Board name Configuration */

/* Project name Configuration */

#define CONFIG_BAREMETAL
...
#define CONFIG_USE_SPI_IOPAD
#define CONFIG_USE_GPIO_IOPAD
#define CONFIG_USE_CAN_IOPAD
#define CONFIG_USE_QSPI_IOPAD
#define CONFIG_USE_PWM_IOPAD
/* CONFIG_USE_ADC_IOPAD is not set */
#define CONFIG_USE_MIO_IOPAD
#define CONFIG_USE_TACHO_IOPAD
...
/* end of Lib */
#define CONFIG_ENABLE_CXX

/* C++ Options */

/* CONFIG_SELECT_CXX_98 is not set */
/* CONFIG_SELECT_CXX_11 is not set */
#define CONFIG_SELECT_CXX_14
/* end of C++ Options */
#define CONFIG_ENABLE_DRY_RUN_EXPORT
