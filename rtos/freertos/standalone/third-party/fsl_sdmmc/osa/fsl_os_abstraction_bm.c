...
static void OSA_EnableGlobalIRQ(uint32_t sr)
{

}

static uint32_t OSA_DisableGlobalIRQ()
{
    return 0U;
}
...
{
    *sr = OSA_DisableGlobalIRQ();
    *sr = 0U;
}

void OSA_ExitCritical(uint32_t sr)
{
    OSA_EnableGlobalIRQ(sr);
}
...
void OSA_EnableIRQGlobal(void)
{
    if (s_osaState.interruptDisableCount > 0U)
    {
        ...
        {
            OSA_EnableGlobalIRQ(s_osaState.interruptRegPrimask);
        }
...
void OSA_DisableIRQGlobal(void)
{
    ...
    if (0U == s_osaState.interruptDisableCount)
    {
        s_osaState.interruptRegPrimask = OSA_DisableGlobalIRQ();
    }
