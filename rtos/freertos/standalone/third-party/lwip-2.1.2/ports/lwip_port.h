...
#define LWIP_PORT_MODE_MULTICAST_ADDRESS_FILITER  LWIP_PORT_CAPS(1) /* Allow multicast address filtering  */
...
#define LWIP_PORT_MODE_RX_POLL_RECV LWIP_PORT_CAPS(4)  /* select poll mode */
#define LWIP_PORT_MODE_UNICAST_ADDRESS_FILITER LWIP_PORT_CAPS(5) /* Allow unicast address filtering  */
/* driver type */
