...
{
    struct FUnwindStackFrame stack_frame  = {0};
...
// #endif
    ...
    stack_frame.fp = regs_p->r11 ;
    stack_frame.sp = regs_p->sp ;
    stack_frame.lr = regs_p->lr ;
    stack_frame.pc = regs_p->pc - 4 ;
    
    FUnwindBacktrace(&stack_frame) ;
    while (1)
    {
    }
}
