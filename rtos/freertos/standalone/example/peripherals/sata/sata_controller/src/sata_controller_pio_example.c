 ...
 *
 *
 * FilePath: sata_controller_pio_example.c
 * Date: 2022-02-10 14:53:42
 * LastEditTime: 2022-02-17 17:46:03
 * Description:  This file is for sata controller pio example functions
 *
 * Modify History:
...
/************************** Function *****************************************/
/* function of sata controller pio example */

int FSataControllerPioExample()
{
    ...
    /*write data*/
    char write_buf[FSATA_BLOCK_SIZE] = "Sata Controller Pio Write Successfully!!!";
    ...
    if (ret == FT_SUCCESS)
    {
        printf("%s@%d: Sata controller pio example success !!! \r\n", __func__, __LINE__);
    }
    else
    {
        printf("%s@%d: Sata controller pio example failed !!!, ret = %d \r\n", __func__, __LINE__, ret);
        return FSATA_ERR_OPERATION;
    }
