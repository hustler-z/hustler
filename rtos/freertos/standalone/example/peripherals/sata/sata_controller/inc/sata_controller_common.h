 ...
 *
 *
 * FilePath: sata_controller_common.h
 * Date: 2022-02-10 14:53:42
 * LastEditTime: 2022-02-17 17:46:03
 * Description:  This file is for sata controller example common definition
 *
 * Modify History:
...
#ifndef  SATA_CONTROLLER_COMMON_H
#define  SATA_CONTROLLER_COMMON_H
...
#define FSATA_DEBUG_TAG "SATA_CONTROLLER_TEST"
...
/*sata test default port num*/
#define FSATA_CONTROLLER_DEFAULT_PORT 0
/*sata test default ahci host*/
#define FSATA_CONTROLLER_TEST_AHCI_HOST 1
/*sata controller test used start block*/
#define FSATA_CONTROLLER_TEST_BLOCK 100
/*sata controller test used block num*/
#define FSATA_CONTROLLER_TEST_BLOCK_NUM 1
/*sata controller init function*/
FError FSataControllerInit(u32 ahci_host);
/*sata controller read and write funtion*/
