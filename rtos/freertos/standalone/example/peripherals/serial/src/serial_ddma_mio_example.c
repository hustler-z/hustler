 ...
 *
 *
 * FilePath: serial_ddma_mio_example.c
 * Date: 2023-04-12 14:53:42
 * LastEditTime: 2023-06-21 17:57:24
 * Description:  This file is for serial MIO transfer under control of DDMA example function implementation.
 *
 * Modify History:
...
#define DDMA_CONTROLLER_ID  FDDMA1_ID
#define TX_CHAN_ID          0
#define RX_CHAN_ID          1
#define TX_SLAVE_ID         FDDMA1_MIO15_TX_SLAVE_ID
#define RX_SLAVE_ID         FDDMA1_MIO15_RX_SLAVE_ID
...
static FError FSerialDdmaMioTest()
{
...
static FError FSerialDdmaMioInit()
{
    FError ret;
...
static FError FSerialDdmaMioDeinit()
{
    FError ret;
...
/* function of serial MIO transfer under control of DDMA example */
int FSerialDdmaMioExample()
{
    int ret = 0;
    /*init iomux*/
    FIOMuxInit();
    /* hardware init */
    ret = FSerialDdmaMioInit();
    if (ret != FT_SUCCESS)
    {
    ...
    memset(rx_recv_data, 0, sizeof(rx_recv_data));
