 ...
 *
 *
 * FilePath: i2s_tx_example.c
 * Created Date: 2023-10-07 15:13:39
 * Last Modified: 2023-12-21 16:22:32
 * Description:  This file is for I2S TX example function implmentation.
 *
 * Modify History:
...
FError FI2sDdmaTxExample(void)
{
    ...
    FI2sDdmaMemoryToDeviceCopy(channel, work_mode, (uintptr)tx_buf, total_byte, per_buffer_len);
