...
#define REMOTEPROC_MASK     0x1 << CONFIG_TARGET_CPU_MASK
...
static int FOpenampTest(int argc,char *argv[])
{
    int ret = 0;
    if (argc != 2)
    {
...
SHELL_EXPORT_CMD(SHELL_CMD_TYPE(SHELL_TYPE_CMD_MAIN), openamp, FOpenampTest, openamptest);
