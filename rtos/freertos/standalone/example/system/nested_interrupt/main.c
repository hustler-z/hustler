 ...
 * Description:  This file is for nested interrupt basic and timer test example main function.
 *
 * Modify History:
 *  Ver       Who         Date           Changes
 * -----     ------     --------     --------------------------------------
 *  1.0    liqiaozhong  2023/8/1     add sgi interrupt test example
 *  1.1    liqiaozhong  2023/9/28    add timer interrupt test example
 */
...
int main()
{
    ...
    FNestedIntSgiExample();
    FNestedIntrTimerExample();
#endif
    return 0;
}