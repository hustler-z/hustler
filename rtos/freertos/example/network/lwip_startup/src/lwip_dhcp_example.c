...
{    
    ...
    {
        printf("%s@%d: Lwip dhcp example failed !!!, ret = %d \r\n", __func__, __LINE__, ret);
    }
...
{
    BaseType_t ret;
    ret = xTaskCreate((TaskFunction_t)LwipDhcpInitTask, /* 任务入口函数 */
                      (const char *)"LwipDhcpInitTask", /* 任务名字 */
                      (uint16_t)2048,                 /* 任务栈大小 */
                        NULL,                   /* 任务入口函数参数 */
