...
#define WIFI_CORE_STACK_SIZE          (20480)
#define WIFI_SCAN_STACK_SIZE          (10240)
#define WIFI_DRV_STACK_SIZE           (10240)
...
static os_thread_stack_define(wifi_scan_stack, WIFI_SCAN_STACK_SIZE);
static os_thread_stack_define(wifi_drv_stack, WIFI_DRV_STACK_SIZE);
