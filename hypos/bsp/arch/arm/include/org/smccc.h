...
static inline u32 smccc_get_fn(register_t funcid)
{
    return funcid & ARM_SMCCC_FUNC_MASK;
}

/* Get service owner number from function identifier. */
static inline u32 smccc_get_owner(register_t funcid)
{
...
#define __declare_arg_0(a0, res)                            \
    ...
    register unsigned long  r0 ASM_REG(0) = (u32)(a0);      \
