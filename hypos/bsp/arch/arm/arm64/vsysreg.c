...
#if IS_IMPLEMENTED(__VSYSREG_IMPL)
// --------------------------------------------------------------
#include <asm/hcpu.h>
#include <asm/esr.h>
#include <bsp/vcpu.h>
 ...
 */
#define TVM_REG(reg)                                                \
static bool vreg_emulate_##reg(struct hcpu_regs *regs,              \
...
void do_sysreg(struct hcpu_regs *regs,
               const union hcpu_esr hsr)
{
     ...
     */
    case ESR_SYSREG_DCISW:
    case ESR_SYSREG_DCCSW:
    case ESR_SYSREG_DCCISW:
        if ( !hsr.sysreg.read )
     ...
     *    DBGPRCR_EL1
     */
    case ESR_SYSREG_OSLAR_EL1:
        return handle_wo_wi(regs, regidx, hsr.sysreg.read, hsr, 1);
    case ESR_SYSREG_OSDLR_EL1:
        return handle_raz_wi(regs, regidx, hsr.sysreg.read, hsr, 1);
    case ESR_SYSREG_OSLSR_EL1:
    ...
    case ESR_SYSREG_DBGDTR_EL0:
    /* DBGDTR[TR]X_EL0 share the same encoding */
    case ESR_SYSREG_DBGDTRTX_EL0:
        /*
    ...
    ESR_SYSREG_DBG_CASES(DBGBVR):
    ESR_SYSREG_DBG_CASES(DBGBCR):
    ESR_SYSREG_DBG_CASES(DBGWVR):
    ESR_SYSREG_DBG_CASES(DBGWCR):
        return handle_raz_wi(regs, regidx, hsr.sysreg.read, hsr, 1);
     ...
     */
    case ESR_SYSREG_PMINTENSET_EL1:
    case ESR_SYSREG_PMINTENCLR_EL1:
        /*
         * Accessible from EL1 only, but if EL0 trap happens handle as
         * undef.
         */
        return handle_raz_wi(regs, regidx, hsr.sysreg.read, hsr, 1);
    case ESR_SYSREG_PMUSERENR_EL0:
        /* RO at EL0. RAZ/WI at EL1 */
        if ( regs_mode_is_user(regs) )
            return handle_ro_raz(regs, regidx, hsr.sysreg.read, hsr, 0);
        else
            return handle_raz_wi(regs, regidx, hsr.sysreg.read, hsr, 1);
    case ESR_SYSREG_PMCR_EL0:
    case ESR_SYSREG_PMCNTENSET_EL0:
    case ESR_SYSREG_PMCNTENCLR_EL0:
    case ESR_SYSREG_PMOVSCLR_EL0:
    case ESR_SYSREG_PMSWINC_EL0:
    case ESR_SYSREG_PMSELR_EL0:
    case ESR_SYSREG_PMCEID0_EL0:
    case ESR_SYSREG_PMCEID1_EL0:
    case ESR_SYSREG_PMCCNTR_EL0:
    case ESR_SYSREG_PMXEVTYPER_EL0:
    case ESR_SYSREG_PMXEVCNTR_EL0:
    case ESR_SYSREG_PMOVSSET_EL0:
        /*
    ...
    case ESR_SYSREG_ID_AA64PFR0_EL1:
    {
    ...
    case ESR_SYSREG_ID_AA64ZFR0_EL1:
    {
        /*
     ...
     */
    case ESR_SYSREG(3,0,c0,c3,3):
    case ESR_SYSREG(3,0,c0,c3,7):
    case ESR_SYSREG(3,0,c0,c4,2):
    case ESR_SYSREG(3,0,c0,c4,3):
    case ESR_SYSREG(3,0,c0,c4,5):
    case ESR_SYSREG(3,0,c0,c4,6):
    case ESR_SYSREG(3,0,c0,c4,7):
    case ESR_SYSREG(3,0,c0,c5,2):
    case ESR_SYSREG(3,0,c0,c5,3):
    case ESR_SYSREG(3,0,c0,c5,6):
    case ESR_SYSREG(3,0,c0,c5,7):
    case ESR_SYSREG(3,0,c0,c6,2):
    case ESR_SYSREG(3,0,c0,c6,3):
    case ESR_SYSREG(3,0,c0,c6,4):
    case ESR_SYSREG(3,0,c0,c6,5):
    case ESR_SYSREG(3,0,c0,c6,6):
    case ESR_SYSREG(3,0,c0,c6,7):
    case ESR_SYSREG(3,0,c0,c7,3):
    case ESR_SYSREG(3,0,c0,c7,4):
    case ESR_SYSREG(3,0,c0,c7,5):
    case ESR_SYSREG(3,0,c0,c7,6):
    case ESR_SYSREG(3,0,c0,c7,7):
        return handle_ro_raz(regs, regidx, hsr.sysreg.read, hsr, 1);
 ...
 fail:
    MSGE("%s %d, %d, c%d, c%d, %d %s x%d @ 0x%016lx\n",
         sysreg.read ? "mrs" : "msr",
         ...
         sysreg.read ? "=>" : "<=",
         sysreg.reg, regs->pc);
    MSGE("unhandled 64-bit sysreg access %016lx\n",
         hsr.bits & ESR_SYSREG_REGS_MASK);
