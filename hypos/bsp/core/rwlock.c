                ...
                percpu_rwlock_t *percpu_rwlock)
{
     ...
     *
     * Note we use the speculation unsafe variant of write_lock(),
     * as the calling wrapper already adds a speculation barrier
    ...
    /* Check if there are any percpu readers in progress on this
     * rwlock.
     */
    for ( ; ; ) {
