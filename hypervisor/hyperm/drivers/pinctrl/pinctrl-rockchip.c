						...
						struct platform_device *pdev)
{
	...
	for (i = 0; i < ctrl->nr_banks; ++i, ++bank) {
		...
		// raw_spin_lock_init(&bank->slock); /* TO DO */
		bank->drvdata = d;
...
static int __maybe_unused rk3308_soc_data_init(struct rockchip_pinctrl *info)
{
	int ret;
